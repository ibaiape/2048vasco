...
public class AnimLayer extends FrameLayout {
	...
	//Localiza una celda, crea una animación para su movimiento y se la aplica
	...
	//Coge una "carta" del array de celdas libres (si no crea otra), la hace visible y le establece el número pasado
	...
	//Hace invisible una celda, elimina su animación y la añade al array de celdas libres
	...
	//Lista de celdas libres y listas para usar
